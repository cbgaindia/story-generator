export const topics = [
    {
        ...
        name: 'Number of districts where legal aid counsel were appointed for all magistrate courts/ ( Number of districts which responded to the RTI)',
    ...
    },
    {
        ...
        sub_theme_url_slug: 'access-to-legal-aid/appointments',
        name: 'Number of districts where panel lawyers were appointed/( Number of districts which responded to the RTI)',
    ...
    },
    {
        ...
        sub_theme_url_slug: 'access-to-legal-aid/appointments',
        name: 'Number of districts where retainer lawyers were appointed/(Number of districts which responded to the RTI)',
