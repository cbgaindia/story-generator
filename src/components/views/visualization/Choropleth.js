    ...
    render() {
        return (
            <div className="row vis-wrapper">
                <Map center={config.params.center} zoom={config.params.zoom} zoomControl={config.params.zoomControl}
                    ...
                    <div className="tcontainer">
                        <YearSelector handleYearChange={this.handleYearChange}
                                      fiscalYears={this.getYearList(this.props.data)}
                                      selectedYear={this.state.selectedYear}/>
                    </div>

                    <div className="statetooltip">
                        <StateToolTip statetooltip={this.state.hoverstate} allocations={this.state.hoverFigure}
                            ...
                            <ul className="legend-labels">
                                ...
                                <li>
                                    <span className="legendspanside"
                                          style={{"background": "#BFBFBF"}}>Data Unavailable</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="license-text">
                        ...
                        <a href="https://openbudgetsindia.org" target="_blank">Open Budgets India</a>
                    </div>
                </Map>
